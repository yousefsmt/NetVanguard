...
static enum socket_type_t parse_args( struct socket_config_t* socket_config, struct socket_address_t* socket_address,
...
int main( int argc, char* argv[] )
{
    ...
    SUCCESS( "Role side: %s", ( socket_type == SERVER_SIDE ) ? "SERVER_SIDE" : "CLIENT_SIDE" );
